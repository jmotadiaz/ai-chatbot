...
export const defaultMetaPrompt = `
  ...
  5. **Structural Delimiters**: Use XML tags (e.g., <context>, <rules>, <format>) or Markdown headers (##) to separate sections within the refined prompt for clarity and to prevent prompt injection.
