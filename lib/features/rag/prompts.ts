...
export const systemPrompt = `
  ...
  **Step 3: Generate the Query Rewrite**
  ...
  **Step 4: Execute the ${RAG_TOOL} tool**
  * **MANDATORY Action:** Use the generated multi-hop queries and query rewrite to execute the ${RAG_TOOL} tool.

  **CRITICAL**: The ${RAG_TOOL} tool strictly requires English inputs to function with maximum accuracy..
`;
