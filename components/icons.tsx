...
export const MistralIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    viewBox="0 0 24 24"
    width={size}
...
export const MiniMaxIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    viewBox="0 0 24 24"
    width={size}
...
export const ZaiIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    fill="currentColor"
    fillRule="evenodd"
    height={size}
...
export const XiaomiIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    version="1.1"
    fill="currentColor"
    height={size}
    ...
    enableBackground="new -200.008 -199.727 512 512"
    xmlSpace="preserve"
  >
    <g>
      <g>
        <g>
          <path fill="#FF6900" d="M258.626-146.231c-48.304-48.118-117.759-53.496-202.634-53.496
      ...
      <g>
        <g>
          <path fill="#FFFFFF" d="M204.546-41.122c1.759,0,3.223,1.417,3.223,3.161v189.386
...
export const ImageSparkleIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
