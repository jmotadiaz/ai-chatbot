...
export const ClaudeIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    viewBox="0 0 24 24"
    width={size}
...
export const GrokIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    fill="currentColor"
    fillRule="evenodd"
    height={size}
...
export const MoonshotIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    viewBox="0 0 24 24"
    width={size}
...
export const PerplexityIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    viewBox="0 0 24 24"
    width={size}
...
export const QwenIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    viewBox="0 0 24 24"
    width={size}
